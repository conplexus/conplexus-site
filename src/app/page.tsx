    ...
    <>
      ...
      <main className="min-h-screen bg-conx-navy text-white px-6 py-12 pt-28 space-y-44">
        ...
        <section className="text-center space-y-6">
          ...
          <a
            href="#about"
            className="inline-block bg-conx-green text-conx-navy font-semibold py-3 px-7 rounded-xl2 shadow-brand hover:brightness-95 active:translate-y-[1px] transition"
          >
            Learn More
          </a>
        </section>
